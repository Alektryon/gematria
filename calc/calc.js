...
function createCiphersMenu() { // create menu with all cipher catergories
	...
	o += '<div class="dropdown-content" style="width: 432px; min-height: 222px;">'
	...
	o += '<div style="width: 34%; float: left;">'
	...
	o += '<div style="width: 66%; float: left;">'
...
function createAboutMenu() { // create menu with all cipher catergories
	...
	o += '<div style="text-align: center;"><span class="qgVer">'+'Edited by Alektryon'+'</span></div>'
...
function enableAllEnglishCiphers() {
	...
	var cur_chkbox
	for (i = 0; i < cipherList.length; i++) {
		if (cipherList[i].cArr.indexOf(97) > -1 && cipherList[i].cipherCategory !== 'Extra' && cipherList[i].cipherCategory !== 'Experimental' && cipherList[i].cipherCategory !== 'Cryptography') { // lowercase "a", not "Other" categories
			cur_chkbox = document.getElementById("cipher_chkbox"+i)
			cipherList[i].enabled = true
			if (cur_chkbox !== null) cur_chkbox.checked = true
		}
